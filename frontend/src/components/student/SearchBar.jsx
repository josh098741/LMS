...
function SearchBar({data}){
    ...
    return(
        <form onSubmit={onSearchHandler} className="max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded">
            ...
            <input onChange={event => setInput(event.target.value)} value={input} type="text" placeholder="search for courses" className="w-full h-full outline-none text-gray-500/80"/>
